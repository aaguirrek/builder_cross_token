...
<template>
  <div class="MatcWidget MatchWidgetTypeButton MatcEventedWidget MatcSimulatorClickable">
      ...
      <div data-dojo-attach-point="labelNode" class="MatcInlineEditable" v-html="value"></div>
  </div>
</template>
<script>
...
//import {useStore} from "core/engines/piniaStore";
...
export default {
  ...
  methods: {
    ...
    onClick(e) {
      ...
      //let storeEl={}
      //storeEl[this.internal_id]=this.value
      //store.$patch(storeEl)
      this.stopEvent(e);
      this.emitClick(e);
    }
