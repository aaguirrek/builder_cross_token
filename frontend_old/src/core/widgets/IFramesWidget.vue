<template>
    <div class="MatcIFrameWidget">
        <div class="MatcIFrameWidgetCover">
            <span class="" v-if="!url"> Iframe</span>
            <span class="mdi mdi-youtube" v-if="!url" :style="'fontSize:' + fontSize">
            </span>            
        </div>
        <iframe width="100%" height="100%" v-if="url" :src="url" title="" class="MatcIFrameWidgetFrame" sandbox="allow-scripts allow-same-origin"></iframe>
    </div>
