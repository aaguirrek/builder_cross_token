		  ...
		  async postCreate (){
			  ...
			  if(this.mode == "standalone"){
				  ...
				  if (this.embedded) {
					  ...
					  let hash = "a2aa10aZzqflgfz6NT5kOZ2jhv1XOPytzUSTB0hz8NHmEv4Wfj9oFFL2q85W"
					  if (hash.length < 60) {
						  this.showPassword(hash)
					  } else {
						  this.setInvitation("a2aa10aZzqflgfz6NT5kOZ2jhv1XOPytzUSTB0hz8NHmEv4Wfj9oFFL2q85W");
						  Services.getModelService().findAppByHash("a2aa10aZzqflgfz6NT5kOZ2jhv1XOPytzUSTB0hz8NHmEv4Wfj9oFFL2q85W").then(app => this.loadSettings(app))
					  }
