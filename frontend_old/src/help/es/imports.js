export let texts = [
    {
        ...
        "title": "Import",
        "body": `
           You can import images (png, jpg) or Figma projects into Builder.
        `,
        "paragraphs": [
            {
                "id": "import.bitmap",
                "title": "Image Import",
                "body": `
                    You can import PNG and JPEG files from other tools into Builder. Simply drag and drop them on the canvas,
            ...
            },
            {
                ...
                "body": `
                    You can import Figma projects into Builder by opening the Import wizard. Before you start you need to create an Access key:
