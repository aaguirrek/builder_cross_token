export let texts = [
  {
      ...
      "title": "User Surveys",
      "body": `
          When users test a Builder prototype, the user input is saved. For instance, a Star Rating that they are giving is stored.
          ...
          Builder comes with many elements that can be used to collect direct user feedback. In the widget menu in the design canvas,
