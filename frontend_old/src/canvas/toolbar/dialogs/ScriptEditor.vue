        ...
        <div class="MatcScriptColumns">
            ...
            <div ref="editCntr" class="MatcScriptEditorIDE">
                ...
                <div class="MatcToolbarTabs MatcToolbarTabsBig">
                    ...
                    <a @click="tab='help'" :class="{'MatcToolbarTabActive': tab === 'help'}">{{getNLS('script.help')}}</a>
                </div>
...
<code>data.sum = data.a + data.b</code>

Use the "event" property to get the source widget:
<code>data.message = event.widget + 'was clicked'</code>

The "buildhub" object let's you manipulate the prototype styles:
<code>
let screen = buildhub.getScreen('myScreen')
...
The "buildhub" object can also trigger (phone) vibrations
buildhub.vibrate([100, 30, 100])

To navigate to a screen, return the name:
<code>return "myScreen"</code>

=================================================

To integrate to Frappe ERP you can use:
...
//Get List Docs:
    ...
    frappe.call({
            ...
            args:{
                ...
                or_filters:[["field1", "=", "value1"], ["field2", ">", "value2"]]
            }
        })
