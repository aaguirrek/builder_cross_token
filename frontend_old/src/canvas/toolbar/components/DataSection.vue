...
export default {
    ...
    methods: {
		...
		_showButtonData(model) {
			this._setSectionLabel("Id Interno");
			this._renderInput(model.props, "internal_id", "the id from button click", "Internal id");
		},
		_showIFramesWidget(model) {
			this._setSectionLabel("IFrame");
			this._renderInput(model.props, "url", "The URL to link", "https://yourlink.com");
		},
		_showLinkexternalWidget(model) {
			this._setSectionLabel("IFrame");
			this._renderInput(model.props, "url", "The URL to link", "https://yourlink.com");
			this._renderInput(model.props, "target", "The target to link", "blank");
		},
